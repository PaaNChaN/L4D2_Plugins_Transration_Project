...
stock AnnounceSIClasses()
{
    ...
    for (new i = 1; i <= MaxClients; i++) {
        ...
        switch (iSpawns) {
            case 4: {
                CPrintToChat(i,
                    "{default}%t {red}%t{default}, {red}%t{default}, {red}%t{default}, {red}%t{default}",
                    "Title",
            ...
            case 3: {
                CPrintToChat(i,
                    "{default}%t {red}%t{default}, {red}%t{default}, {red}%t{default}",
                    "Title",
                    g_csSIClassName[iSpawnClass[0]],
                    g_csSIClassName[iSpawnClass[1]],
                    g_csSIClassName[iSpawnClass[2]]
            ...
            case 2: {
                CPrintToChat(i,
                    "{default}%t {red}%t{default}, {red}%t{default}",
                    "Title",
                    g_csSIClassName[iSpawnClass[0]],
                    g_csSIClassName[iSpawnClass[1]]
                );
